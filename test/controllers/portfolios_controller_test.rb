...
class PortfoliosControllerTest < ActionController::TestCase
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post :create, portfolio: { image_url: @portfolio.image_url, project_description: @portfolio.project_description }
    end
  ...
  test "should update portfolio" do
    patch :update, id: @portfolio, portfolio: { image_url: @portfolio.image_url, project_description: @portfolio.project_description }
    assert_redirected_to portfolio_path(assigns(:portfolio))
  end
