...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { course_description: @education.course_description, course_title: @education.course_title, institution: @education.institution, period: @education.period, results: @education.results }
    end
  ...
  test "should update education" do
    patch :update, id: @education, education: { course_description: @education.course_description, course_title: @education.course_title, institution: @education.institution, period: @education.period, results: @education.results }
    assert_redirected_to education_path(assigns(:education))
  end
